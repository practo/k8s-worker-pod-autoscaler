...
import (
	...
	"github.com/practo/k8s-sqs-pod-autoscaler-controller/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type K8sV1alpha1Interface interface {
	RESTClient() rest.Interface
	SqsPodAutoScalersGetter
}

// K8sV1alpha1Client is used to interact with features provided by the k8s.practo.dev group.
type K8sV1alpha1Client struct {
	restClient rest.Interface
}

func (c *K8sV1alpha1Client) SqsPodAutoScalers(namespace string) SqsPodAutoScalerInterface {
	return newSqsPodAutoScalers(c, namespace)
}
