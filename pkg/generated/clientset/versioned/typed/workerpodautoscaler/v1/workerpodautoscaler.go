...
type WorkerPodAutoScalerInterface interface {
	Create(*wpav1.WorkerPodAutoScaler) (*wpav1.WorkerPodAutoScaler, error)
	Update(*wpav1.WorkerPodAutoScaler) (*wpav1.WorkerPodAutoScaler, error)
	UpdateStatus(*wpav1.WorkerPodAutoScaler) (*wpav1.WorkerPodAutoScaler, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*wpav1.WorkerPodAutoScaler, error)
	List(opts v1.ListOptions) (*wpav1.WorkerPodAutoScalerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *wpav1.WorkerPodAutoScaler, err error)
...
func (c *workerPodAutoScalers) Get(name string, options v1.GetOptions) (result *wpav1.WorkerPodAutoScaler, err error) {
...
func (c *workerPodAutoScalers) List(opts v1.ListOptions) (result *wpav1.WorkerPodAutoScalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &wpav1.WorkerPodAutoScalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("workerpodautoscalers").
...
func (c *workerPodAutoScalers) UpdateStatus(workerPodAutoScaler *wpav1.WorkerPodAutoScaler) (result *wpav1.WorkerPodAutoScaler, err error) {
	result = &wpav1.WorkerPodAutoScaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workerpodautoscalers").
...
func (c *workerPodAutoScalers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *wpav1.WorkerPodAutoScaler, err error) {
	result = &wpav1.WorkerPodAutoScaler{}
