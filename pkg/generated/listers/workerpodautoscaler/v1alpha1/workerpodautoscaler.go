...
type WorkerPodAutoScalerLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.WorkerPodAutoScaler, err error)
...
// List lists all WorkerPodAutoScalers in the indexer.
func (s *workerPodAutoScalerLister) List(selector labels.Selector) (ret []*v1alpha1.WorkerPodAutoScaler, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.WorkerPodAutoScaler))
	})
	return ret, err
}
...
type WorkerPodAutoScalerNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.WorkerPodAutoScaler, error)
...
// List lists all WorkerPodAutoScalers in the indexer for a given namespace.
func (s workerPodAutoScalerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.WorkerPodAutoScaler, err error) {
...
// Get retrieves the WorkerPodAutoScaler from the indexer for a given namespace and name.
func (s workerPodAutoScalerNamespaceLister) Get(name string) (*v1alpha1.WorkerPodAutoScaler, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("workerpodautoscaler"), name)
	}
	return obj.(*v1alpha1.WorkerPodAutoScaler), nil
}
